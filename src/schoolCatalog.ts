...
import { schoolQuestionDisplayStem } from './schoolMaterial'
...
export const SCHOOL_QUESTION_TEMPLATES: readonly SchoolQuestionTemplateDefinition[] = [
  ...
  { id: 'insertion', label: '문장 삽입', questionType: '문장 삽입', defaultStem: '글의 흐름으로 보아, 주어진 문장이 들어가기에 가장 적절한 곳은?', choiceLayout: 'inline', promptRule: '[[삽입문장:문장]] 하나와 프롬프트에서 이 문항에 배정한 다섯 [[삽입위치:기호]]를 순서대로 정확히 한 번씩 둔다.' },
...
export function schoolCatalogPromptSection(set: EnglishQuestionSet, questions: EnglishQuestion[]) {
